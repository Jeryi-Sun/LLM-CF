...
from llmtuner.tuner.r3f import run_r3f
...
def run_exp(args: Optional[Dict[str, Any]] = None, callbacks: Optional[List["TrainerCallback"]] = None):
    ...
    elif finetuning_args.stage == "r3f":
        run_r3f(model_args, data_args, training_args, finetuning_args, generating_args, callbacks)
    else:
